...
function init_db(): void {
    ...
    // Seed default users if not exist (passwords hashed with bcrypt)
    $stmt = $db->prepare('INSERT OR IGNORE INTO users (username, password, email) VALUES (?, ?, ?)');
    ...
    $stmt = $db->prepare('INSERT OR IGNORE INTO products (name, price, description, image_url) VALUES (?, ?, ?, ?)');
